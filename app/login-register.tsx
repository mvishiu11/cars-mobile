    ...
    >
      ...
      {activeTab === 'register' && (
        <View>
          ...
          <TextInput
            placeholder="Email" 
            style={{ backgroundColor: '#f9f9f9', borderColor: '#ddd', borderWidth: 1, borderRadius: 8, padding: 12, marginBottom: 16, }} 
          />
          <TextInput 
          ...
          <TextInput 
           ...
           /> 
          <Pressable 
            style={{ backgroundColor: '#003366', paddingVertical: 12, paddingHorizontal: 24, borderRadius: 8, alignItems: 'center', }} 
          > 
            <Text 
